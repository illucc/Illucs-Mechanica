...
import org.valkyrienskies.vscreate.content.contraptions.physJammer.PhysJammerBlock;
import org.valkyrienskies.vscreate.content.contraptions.propellor.PropellorBearingBlock;
import org.valkyrienskies.vscreate.content.contraptions.blipdrive.BlipdriveBlock;
import org.valkyrienskies.vscreate.content.contraptions.springer.SpringerBlock;
...
public class VSCreateBlocks {
    ...
    public static final BlockEntry<PhysJammerBlock> PHYSJAMMER =
            REGISTRATE.block("physics_jammer", PhysJammerBlock::new)
                    .properties(p -> p.color(MaterialColor.PODZOL))
                    .transform(BuilderTransformers.bearing("physics_jammer", "gearbox", false))
                    .tag(AllTags.AllBlockTags.SAFE_NBT.tag)
                    .register();
